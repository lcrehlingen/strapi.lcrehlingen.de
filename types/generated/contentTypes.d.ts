...
export interface ApiTrainingTraining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reha: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    trainers: Schema.Attribute.Relation<'manyToMany', 'api::trainer.trainer'>;
    TrainingTimeRange: Schema.Attribute.Component<
      'list.training-time-range',
      true
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
...
export interface ApiVeranstaltungVeranstaltung
  ...
  attributes: {
    ...
    results: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
