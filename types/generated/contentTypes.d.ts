...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    authors: Attribute.Component<'author.authors', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAthleteAthlete extends Schema.CollectionType {
  ...
  attributes: {
    ...
    discipline: Attribute.String & Attribute.Required;
    text: Attribute.RichText;
    slug: Attribute.UID<'api::athlete.athlete', 'name'>;
    worldathleticsId: Attribute.BigInteger & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiGallerieGallerie extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.UID<'api::gallerie.gallerie', 'name'> & Attribute.Required;
    media: Attribute.Media<'images', true> & Attribute.Required;
    thumbnail: Attribute.Media<'images'> & Attribute.Required;
    date: Attribute.Date & Attribute.Required;
    photographers: Attribute.Component<'author.authors', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTrainingTraining extends Schema.CollectionType {
  ...
  attributes: {
    ...
    reha: Attribute.Boolean & Attribute.DefaultTo<false>;
    trainers: Attribute.Relation<
      'api::training.training',
      'manyToMany',
      'api::trainer.trainer'
    >;
    TrainingTimeRange: Attribute.Component<'list.training-time-range', true> &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 1;
      ...
      >;
    content: Attribute.RichText;
    slug: Attribute.UID<'api::training.training', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiVeranstaltungVeranstaltung extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date & Attribute.Required;
    image: Attribute.Media<'images'> & Attribute.Required;
    slug: Attribute.UID<'api::veranstaltung.veranstaltung', 'name'> &
      Attribute.Required;
    articles: Attribute.Relation<
...
export interface ApiVorstandVorstand extends Schema.CollectionType {
